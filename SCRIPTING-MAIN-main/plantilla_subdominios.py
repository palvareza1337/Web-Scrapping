...
subtabla_evidencia = table_evidencia.rows[1].cells[0].add_table(rows=2, cols=1)
...
doc.save("subdominios_generado.docx")
print("Documento generado: subdominios_generado.docx")
